...
class ProductRepository extends ServiceEntityRepository
{
    ...
    /**
     * Finds products for a given category, joining the category to prevent N+1 issues.
     * @param \App\Entity\Category $category The category entity.
     * @return Product[] Returns an array of Product objects.
     */
    public function findForCategoryPage(\App\Entity\Category $category): array
    {
        return $this->createQueryBuilder('p')
            ->addSelect('c') // Also select the category object
            ->innerJoin('p.category', 'c') // Join on the category relationship
