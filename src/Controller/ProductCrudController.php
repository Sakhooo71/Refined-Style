...
class ProductCrudController extends AbstractController
{
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($file) {
                ...
                try {
                    ...
                    if ($originalImage && file_exists($this->getParameter('uploads_images_directory') . '/' . $originalImage)) {
                        unlink($this->getParameter('uploads_images_directory') . '/' . $originalImage);
                    }
    ...
    public function delete(Request $request, Product $product, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete' . $product->getId(), $request->request->get('_token'))) {
            if ($product->getProductImage() && file_exists($this->getParameter('uploads_images_directory') . '/' . $product->getProductImage())) {
                unlink($this->getParameter('uploads_images_directory') . '/' . $product->getProductImage());
            }
