 ...
 */
final class Version20250908055034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer_order ADD CONSTRAINT FK_3B1CE6A3466D5220 FOREIGN KEY (order_address_id) REFERENCES order_address (id) ON DELETE SET NULL');
